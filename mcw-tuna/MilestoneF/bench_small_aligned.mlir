...
func.func @matmul(%lhs: tensor<96x64xi8>,
                  %rhs: tensor<64x128xi8>) -> tensor<96x128xi32> {
  %c0   = arith.constant 0 : i32
  %init = tensor.empty() : tensor<96x128xi32>
  %acc  = linalg.fill ins(%c0 : i32) outs(%init : tensor<96x128xi32>)
              -> tensor<96x128xi32>
  %r    = linalg.matmul
